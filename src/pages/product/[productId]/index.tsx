...
const Index: NextPage<TProps> = ({ productData, listRelatedProduct }) => {
  ...
  return (
    <>
      <Head>
        <title>{`Website bán đồ điện tử - ${productData?.name}`}</title>
        <meta
          name='description'
          content={description}
        />
        <meta name='viewport' content='initial-scale=1, width=device-width' />
        <meta name="author" content="Website bán đồ điện tử" />
        <meta name="name" content="Chào mừng ghé thăm" />
        <meta name="image" content={productData.image} />
        {/* facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:title" content={`Website bán đồ điện tử - ${productData?.name}`} />
        <meta property="og:description" content={description} />
        <meta property="og:image" content={productData.image} />
        {/* twitter */}
        <meta property="twitter:card" content="website" />
        <meta property="twitter:title" content={`Website bán đồ điện tử - ${productData?.name}`} />
        <meta property="twitter:description" content={productData.description} />
        <meta property="twitter:image" content={`Website bán đồ điện tử - ${productData?.name}`} />
      </Head>
