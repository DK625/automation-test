...
export default function Home(props: TProps) {
    ...
    return (
        <>
            <Head>
                <title>"Website bán đồ điện tử - Danh sách sản phẩm</title>
                <meta name='description'
                      content='Bán hàng điện tử, điện thoại, máy tính bảng - Xây dựng website bán hàng'/>
                <meta name='viewport' content='width=device-width, initial-scale=1'/>
                <meta name='keywords' content='ReactJS, NextJS 14, Typescript, "Website bán đồ điện tử'/>
            </Head>
