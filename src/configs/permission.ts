...
export const PERMISSIONS = {
  ...
  SYSTEM: {
    ...
    STAFF: {
      ...
      CREATE: 'SYSTEM.STAFF.CREATE',
      UPDATE: 'SYSTEM.STAFF.UPDATE',
      DELETE: 'SYSTEM.STAFF.DELETE'
    },
  },
  MANAGE_ORDER: {
    REVIEW: {
...
export const LIST_DATA_PERMISSIONS: any = [
  ...
  { id: 8, name: 'Manage_order', isParent: true, value: 'MANAGE_ORDER' },
  {
    id: 9,
    name: 'Review',
    isParent: false,
  ...
  { id: 11, name: 'Settings', isParent: true, value: 'SETTING' },
  {
    id: 12,
    name: 'City',
    isParent: false,
