...
const OrderProductListPage: NextPage<TProps> = () => {
    ...
    const DELIVERY_ORDER_PRODUCT_STYLE = {
        0: {
            label: "Đã giao ",
            background: theme.palette.secondary.main
        },
    ...
    const columns: GridColDef[] = [
        ...
        },
        {
            ...
            renderCell: params => {
                ...
                return (
                    <>
                        {<OrderStatusStyled background={(DELIVERY_ORDER_PRODUCT_STYLE as any)[row.isDelivered]?.background}
                                            label={t((DELIVERY_ORDER_PRODUCT_STYLE as any)[row.isDelivered]?.label)}/>}
                    </>
                )
            }
        },
