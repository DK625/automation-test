...
const EditOrderProduct = (props: TCreateEditProduct) => {
    ...
    const schema = yup.object().shape({
        ...
        isDelivered: yup.string().required(t('Required_field')),
            ...
            if (idOrder) {
                dispatch(
                    updateOrderProductAsync({
                        ...
                        isDelivered: Number(data?.isDelivered),
            ...
            .then(res => {
                ...
                if (data) {
                    reset({
                        ...
                        isDelivered: String(data.isDelivered),
                                ...
                                <Grid container item md={12} xs={12}>
                                    <Box sx={{height: '100%', width: '100%'}}>
                                        <Grid container spacing={4}>
                                            <Box sx={{height: '100%', width: '100%', backgroundColor: theme.palette.background.paper, borderRadius: '15px', py: 5, px: 4, ml: '20px'}}>
                                            <Grid container spacing={4}>
                                            ...
                                            <Box sx={{height: '100%', width: '100%', backgroundColor: theme.palette.background.paper, borderRadius: '15px', py: 5, px: 4, mt: 5, ml: '20px'}}>
                                            <Grid container spacing={4}>
                                            <Grid item md={12} xs={12}>
                                                <Controller
                                                    name='isPaid'
                                            ...
                                            <Box sx={{height: '100%', width: '100%', backgroundColor: theme.palette.background.paper, borderRadius: '15px', py: 5, px: 4, my: 5, ml: '20px'}}>
                                            <Grid container spacing={4}>
                                            <Grid item md={12} xs={12}>
                                                <Controller
                                                    control={control}
