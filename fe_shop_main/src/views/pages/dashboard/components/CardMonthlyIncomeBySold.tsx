...
const CardMonthlyIncomeBySold = ({rawData}: any) => {
    ...
    const data = {
        ...
        datasets: [
            {
                label: 'Monthly Sales (Unit)',
                data: rawData.map((item: any) => item.totalQuantity),
    ...
    const options = {
        ...
        plugins: {
            ...
            title: {
                display: true,
                text: 'Monthly Sales Overview By Unit',
            },
        },
        scales: {
...
export default CardMonthlyIncomeBySold